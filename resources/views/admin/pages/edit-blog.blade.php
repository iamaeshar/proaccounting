...
<div class="container-fluid">
    ...
    <form class="bg-white border p-4" action="{{ route('blog.update', [$blog->id]) }}" id="edit_blog_form"
        ...
        <div class="form-group cover_img">
            <label for="cover_img">Cover Image:</label>
            <img class="img-fluid" src="/storage/app/public/cover_images/{{$blog->blog_img}}" height="300px" />
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="keywords" name="keywords"
                placeholder="Enter comma separated focussed keywords" value="{{ $blog->keywords }}" />
        </div>

        <div class="form-group">
            <label for="description">Description:</label>
            <textarea class="form-control" id="description" name="description"
                placeholder="Enter Short Description" cols="20" rows="5">{{ $blog->description }}</textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-2">
                ...
                <input type="text" pattern="^[a-zA-Z0-9-_]+$" class="form-control" id="url" name="url"
                    placeholder="Enter URL slug" value="{{ $blog->url }}" />
            </div>
        </div>
        <!-- ------------------------- -->
...
<script>
    ...
    $(document).ready(function() {
        ...
        var delta = quill.clipboard.convert({!! json_encode($blog->blog_content) !!});
        ...
        var form = document.querySelector('#edit_blog_form');
